...
simulation = driftator.simulation.chargerJson("config/" + os.listdir('config')[select-1], dT)

#Initialisation de l'affichage
affichage = driftator.affichage.Affichage(simulation, controleur, 30, 1.5, False)

#Initialisation du controleur
implem = driftator.ia.implemSimulation(simulation.getRobot(0), simulation)
